...
import { Card, CardContent, CardActions, InputAdornment, Typography } from "@mui/material";
// COMPONENTS
import {
  InputData,
  ButtonsSubmitCancel,
    ...
    <form autoComplete="off">
      ...
      <Card>
        <CardContent component={Grid} container spacing={3}>
          ...
          />
          <Grid xs={12}>
            <Typography color="neutral.600" variant="subtitle2">Lista de ingredientes</Typography>
