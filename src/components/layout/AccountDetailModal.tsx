...
import { Box, Popover, MenuList, MenuItem, Typography, Avatar } from '@mui/material';
...
export default function AccountDetailModal() {
    ...
    const [openModal, setOpenModal] = useState<Element | null>(null);
        ...
        <>
            ...
            >
                <Box sx={{ py: 1.5, px: 2 }}>
                    ...
                    <Typography color="text.secondary" variant="body2">{usuario.email}</Typography>
                </Box>
                <MenuList
                    disablePadding
                    sx={{
                ...
                >
                    <MenuItem onClick={handleLogoutOut}>
                        <Typography pr={27} color="text.secondary" variant="body2">Sair</Typography>
